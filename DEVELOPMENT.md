...
| [Preset / Extension coding standard](docs/preset-extension-coding-standard.md) | Required implementation boundaries, prompt style, contracts, lifecycle, and review gates for presets and extensions. |
